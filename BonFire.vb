...
Class BonfireProgressBar
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim textX As Integer = ((Width - 1) / 2) - (G.MeasureString(txt, Font).Width / 2)
        Dim textY As Integer = (Height / 2) - (G.MeasureString(txt, Font).Height / 2) + 1
        'G.DrawString(txt, Font, Brushes.Black, New Point(textX, textY))
